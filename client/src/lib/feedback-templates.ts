...
/**
 * Client-side feedback template engine — ported from server/feedback-templates.ts
 * for the static GitHub Pages build. Zero AI, zero external APIs, runs entirely
 * in the browser.
 */
